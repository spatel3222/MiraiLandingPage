-- ================================================================
-- MOI Analytics Dashboard - Meta Advertising Data Import
-- ================================================================
...
-- Table: meta_raw_data
-- Features: Conflict resolution, indexing, audit trail
-- ================================================================
...
CREATE INDEX IF NOT EXISTS idx_meta_amount_spent ON meta_raw_data(amount_spent_inr);
CREATE INDEX IF NOT EXISTS idx_meta_campaign_date ON meta_raw_data(campaign_name, reporting_starts);

-- Begin batch data insertion with conflict resolution
-- Processing all Meta advertising campaign records
