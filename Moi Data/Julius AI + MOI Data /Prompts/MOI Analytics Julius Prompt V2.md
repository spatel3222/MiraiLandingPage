...
- **Meta**: Meta_Ads_1st-Oct.csv … Meta_Ads_6th_Oct.csv
- **Google**: Google_1st_Oct.csv … Google_6th_Oct.csv
- **Shopify**: Shopify_1st_Oct.csv … Shopify_6th_Oct.csv
- **Unified prior**: unified_ads_shopify_oct1_6.csv (for context/reference only)
