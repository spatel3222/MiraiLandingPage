...
- **Green**: Scale aggressively = top tier : ad_score ≥0.90 = scale
- **Light Green**: Cautious scale = above average : ad_score us 0.80–0.90 = test-to-scale
- **Purple**: Optimize cost = below average : ad_score is 0.70–0.80 = optimize
- **Red**: Pause or reduce = underperforming : ad_score  <0.70 = pause/fix
...
Append Save **sample_data** with key fields:
- 
- Source, Campaign, Ad Set, Ad, Spend, Visitors, Good Leads, Checkouts, Days Active
- Good Lead Rate (Shrunk), Cost per Good Lead (Shrunk), Ad Score, Color, Recommendation, Confidence
- Filename: append to current `ad_level_leaderboard.csv`
