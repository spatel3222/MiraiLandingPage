...
export default function ReportsPage() {
  ...
  const processLargeDataset = async () => {
    ...
    const platforms = (['meta', 'google', 'shopify'] as const).filter(p => retrievedData[p as keyof typeof retrievedData]?.length && retrievedData[p as keyof typeof retrievedData]!.length > 0)
